# luaotfload-tool
# Autogenerated from man page /Library/TeX/Distributions/.DefaultTeX/Contents/Man/man1/luaotfload-tool.1
...
complete -c luaotfload-tool -l warnings -s w --description 'Print the warnings generated by the fontloader library (assumes -I).'
